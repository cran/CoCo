...
(if (not (boundp '*mips*))
    (load (concatenate 'string *xlisp-cocolib* "/src/" "cococg"))
  )
...
;;   (load (concatenate 'string *xlisp-cocolib* "/"     "mips-factor.lsp"))
...
(if (not (boundp '*mips*))
    (progn
     (load (concatenate 'string *xlisp-cocolib* "/src/" "cgblocks"))
     (load (concatenate 'string *xlisp-cocolib* "/src/" "cgtest"))
     ))
