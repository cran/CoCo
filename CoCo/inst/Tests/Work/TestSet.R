...
# make.current.coco (2) ;
  ...
  "set.acceptance" ;                  set.acceptance () ;
  "set.rejection" ;                   set.rejection () ;
  "set.test" ;                        set.test () ;
...
# ?
"set.ips.stop" ;                   set.ips.stop("what")
...
"set.algorithm" ;                  set.algorithm("what")
for (i in c("a", "b", "c")) {
  set.algorithm(i)
  set.algorithm("what")
}
"set.acceptance" ;                 set.acceptance("what")
"set.rejection" ;                  set.rejection("what")
...
"set.ic" ;                         set.ic("what")
"set.components" ;                 set.components("what")
"set.separators" ;                 set.separators("what")
...
"set.acceptance" ;                 set.acceptance( c( 0.10 ) ) ;             set.acceptance("what")
"set.rejection" ;                  set.rejection( c( 0.25 ) ) ;              set.rejection("what")
...
"set.components" ;                 set.components( c( .50 ) ) ;              set.components("what")
"set.separators" ;                 set.separators( c( .60 ) ) ;              set.separators("what")
...
#
"set.read" ;                       set.read( "all" ) ;                       set.read("what")
"set.read" ;                       set.read( "subset" ) ;                    set.read("what")
